...
const App = () => {
        ...
        <div className="main-content">
            ...
            <div className="dashboard-section-header">
                ...
                {permissions.canSubmitClaim && (
                    <Button variant="primary" onClick={() => navigateTo('SUBMIT_CLAIM')}>Submit New Claim</Button>
                )}
            </div>
            ...
            <div className="dashboard-grid">
                {claimsData.length > 0 ? (
                    ...
                    <Card style={{ gridColumn: '1 / -1', textAlign: 'center', padding: 'var(--spacing-xxl)' }}>
                        ...
                        {permissions.canSubmitClaim && (
                            <Button variant="primary" onClick={() => navigateTo('SUBMIT_CLAIM')}>Submit Your First Claim</Button>
                        )}
                    </Card>
                )}
            </div>
    ...
    return (
        <div className="app-container">
            ...
            {view.screen === 'SUBMIT_CLAIM' && <OtherScreen name="Submit New Claim" />}
